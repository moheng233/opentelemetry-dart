...
class TracesData extends $pb.GeneratedMessage {
  ...
  factory TracesData.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory TracesData.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pPM<ResourceSpans>(1, _omitFieldNames ? '' : 'resourceSpans',
        subBuilder: ResourceSpans.create)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  TracesData clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  @$pb.TagNumber(1)
  $pb.PbList<ResourceSpans> get resourceSpans => $_getList(0);
}
...
class ResourceSpans extends $pb.GeneratedMessage {
  ...
  factory ResourceSpans.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory ResourceSpans.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pPM<ScopeSpans>(2, _omitFieldNames ? '' : 'scopeSpans',
        subBuilder: ScopeSpans.create)
    ..aOS(3, _omitFieldNames ? '' : 'schemaUrl')
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ResourceSpans clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class ScopeSpans extends $pb.GeneratedMessage {
  ...
  factory ScopeSpans.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory ScopeSpans.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pPM<Span>(2, _omitFieldNames ? '' : 'spans', subBuilder: Span.create)
    ..aOS(3, _omitFieldNames ? '' : 'schemaUrl')
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ScopeSpans clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class Span_Event extends $pb.GeneratedMessage {
  ...
  factory Span_Event.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory Span_Event.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pPM<$1.KeyValue>(3, _omitFieldNames ? '' : 'attributes',
...
class Span_Link extends $pb.GeneratedMessage {
  ...
  factory Span_Link.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory Span_Link.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pPM<$1.KeyValue>(4, _omitFieldNames ? '' : 'attributes',
        subBuilder: $1.KeyValue.create)
    ..aI(5, _omitFieldNames ? '' : 'droppedAttributesCount',
        fieldType: $pb.PbFieldType.OU3)
    ..aI(6, _omitFieldNames ? '' : 'flags', fieldType: $pb.PbFieldType.OF3)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  Span_Link clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  @$pb.TagNumber(1)
  set traceId($core.List<$core.int> value) => $_setBytes(0, value);
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(5)
  set droppedAttributesCount($core.int value) => $_setUnsignedInt32(4, value);
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set flags($core.int value) => $_setUnsignedInt32(5, value);
  @$pb.TagNumber(6)
...
class Span extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aE<Span_SpanKind>(6, _omitFieldNames ? '' : 'kind',
    ...
    ..pPM<$1.KeyValue>(9, _omitFieldNames ? '' : 'attributes',
        subBuilder: $1.KeyValue.create)
    ..aI(10, _omitFieldNames ? '' : 'droppedAttributesCount',
        fieldType: $pb.PbFieldType.OU3)
    ..pPM<Span_Event>(11, _omitFieldNames ? '' : 'events',
        subBuilder: Span_Event.create)
    ..aI(12, _omitFieldNames ? '' : 'droppedEventsCount',
        fieldType: $pb.PbFieldType.OU3)
    ..pPM<Span_Link>(13, _omitFieldNames ? '' : 'links',
        subBuilder: Span_Link.create)
    ..aI(14, _omitFieldNames ? '' : 'droppedLinksCount',
        fieldType: $pb.PbFieldType.OU3)
    ..aOM<Status>(15, _omitFieldNames ? '' : 'status',
        subBuilder: Status.create)
    ..aI(16, _omitFieldNames ? '' : 'flags', fieldType: $pb.PbFieldType.OF3)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(4)
  set parentSpanId($core.List<$core.int> value) => $_setBytes(3, value);
  @$pb.TagNumber(4)
  $core.bool hasParentSpanId() => $_has(3);
  @$pb.TagNumber(4)
  void clearParentSpanId() => $_clearField(4);
  ...
  @$pb.TagNumber(6)
  set kind(Span_SpanKind value) => $_setField(6, value);
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set startTimeUnixNano($fixnum.Int64 value) => $_setInt64(6, value);
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set endTimeUnixNano($fixnum.Int64 value) => $_setInt64(7, value);
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(10)
  set droppedAttributesCount($core.int value) => $_setUnsignedInt32(9, value);
  @$pb.TagNumber(10)
  ...
  @$pb.TagNumber(12)
  set droppedEventsCount($core.int value) => $_setUnsignedInt32(11, value);
  @$pb.TagNumber(12)
  ...
  @$pb.TagNumber(14)
  set droppedLinksCount($core.int value) => $_setUnsignedInt32(13, value);
  @$pb.TagNumber(14)
  $core.bool hasDroppedLinksCount() => $_has(13);
  @$pb.TagNumber(14)
  void clearDroppedLinksCount() => $_clearField(14);
  ...
  @$pb.TagNumber(15)
  set status(Status value) => $_setField(15, value);
  @$pb.TagNumber(15)
  ...
  @$pb.TagNumber(16)
  set flags($core.int value) => $_setUnsignedInt32(15, value);
  @$pb.TagNumber(16)
  $core.bool hasFlags() => $_has(15);
  @$pb.TagNumber(16)
  void clearFlags() => $_clearField(16);
}
...
class Status extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aE<Status_StatusCode>(3, _omitFieldNames ? '' : 'code',
  ...
  @$pb.TagNumber(3)
  set code(Status_StatusCode value) => $_setField(3, value);
  @$pb.TagNumber(3)
